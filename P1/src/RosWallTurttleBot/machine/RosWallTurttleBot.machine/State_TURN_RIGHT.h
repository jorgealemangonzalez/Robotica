...
//
#ifndef __clfsm__RosWallTurttleBot_State_TURN_RIGHT_h__
#define __clfsm__RosWallTurttleBot_State_TURN_RIGHT_h__
...
#endif // defined(__gufsm__RosWallTurttleBot_State_TURN_RIGHT__)
