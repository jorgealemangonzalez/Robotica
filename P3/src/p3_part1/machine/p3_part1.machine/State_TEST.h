...
//
#ifndef __clfsm__p3_part1_State_TEST_h__
#define __clfsm__p3_part1_State_TEST_h__
		...
		namespace FSMp3_part1
		{
			namespace State
			{
				class TEST: public CLState
				{
					...
					{
						public:
						Transition_3(int toState = 1): CLTransition(toState) {}
...
#endif // defined(__gufsm__p3_part1_State_TEST__)
