...
{
	_transitions[0] = new Transition_0();	_transitions[1] = new Transition_1();	_transitions[2] = new Transition_2();	_transitions[3] = new Transition_3();
}
...
bool TEST::Transition_3::check(CLMachine *_machine, CLState *_state) const
{
#	include "p2_part3_VarRefs.mm"
#	include "State_TEST_VarRefs.mm"
	...
	return
	(
#			include "State_TEST_Transition_3.expr"
	);
}
