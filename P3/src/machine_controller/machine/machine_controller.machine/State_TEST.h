...
//
#ifndef __clfsm__machine_controller_State_TEST_h__
#define __clfsm__machine_controller_State_TEST_h__
...
#endif // defined(__gufsm__machine_controller_State_TEST__)
