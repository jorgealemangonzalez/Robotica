...
//
#ifndef __clfsm__TurtleSuspendResume_State_InitialPseudoState_h__
#define __clfsm__TurtleSuspendResume_State_InitialPseudoState_h__
...
#endif // defined(__gufsm__TurtleSuspendResume_State_InitialPseudoState__)
